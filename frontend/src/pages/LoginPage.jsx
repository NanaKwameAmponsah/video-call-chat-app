    ...
    >
              ...
              <div className="space-y-4">
                <div>
                  <h2 className="text-xl font-semibold">
                    We’re Delighted To Welcome You Once More
                  </h2>
                  <p className="text-sm opacity-70">
                    Sign in to your account to continue the mutual pursuit of
                    the truth
                  </p>
                </div>
      ...
      <div className="hidden lg:flex flex-col bg-base-200 w-1/2 p-4 sm:p-8">
        ...
        <div className="relative aspect-square max-w-sm mx-auto">
          <img src="/philosophers_1.png" alt="Language connection illustration" className="w-full h-full" />
        </div>
